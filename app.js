...
300|epicos|Férias Supremo|Viagem de férias planejada.|100000`;
        ...
        // Catálogo grande de missões. Cada pessoa recebe 4 missões secretas e diferentes por dia.
        const DAILY_QUEST_POOL = [
            { id: 'q1', title: 'Dizer "eu te amo" em um momento inesperado', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 20, xp: 15 },
            { id: 'q2', title: 'Mandar uma mensagem carinhosa durante o dia', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 20 },
            { id: 'q3', title: 'Fazer um elogio sincero sobre a personalidade', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 30, xp: 10 },
            { id: 'q4', title: 'Dar um abraço de pelo menos 20 segundos', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 15, xp: 15 },
            { id: 'q5', title: 'Perguntar como foi o dia e ouvir com atenção', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 20, xp: 20 },
            { id: 'q6', title: 'Enviar uma música que lembre vocês dois', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 10 },
            { id: 'q7', title: 'Agradecer por uma atitude específica do seu amor', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 30, xp: 15 },
            { id: 'q8', title: 'Dar um beijo inesperado', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 15, xp: 20 },
            { id: 'q9', title: 'Perguntar qual foi a melhor parte do dia', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 20, xp: 10 },
            { id: 'q10', title: 'Fazer seu amor rir de propósito', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 15 },
            { id: 'q11', title: 'Mandar um áudio dizendo algo que admira', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 30, xp: 20 },
            { id: 'q12', title: 'Compartilhar uma foto do seu momento atual', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 15, xp: 10 },
            { id: 'q13', title: 'Desejar bom dia de um jeito especial', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 20, xp: 15 },
            { id: 'q14', title: 'Desejar boa noite com uma mensagem carinhosa', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 20 },
            { id: 'q15', title: 'Fazer um carinho por pelo menos 5 minutos', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 30, xp: 10 },
            { id: 'q16', title: 'Oferecer ajuda em uma tarefa sem ser solicitado', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 15, xp: 15 },
            { id: 'q17', title: 'Preparar ou buscar um copo de água para seu amor', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 20, xp: 20 },
            ...
            { id: 'q25', title: 'Perguntar o que deixaria o dia do seu amor melhor', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 20, xp: 15 },
            { id: 'q26', title: 'Compartilhar uma pequena conquista do seu dia', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 20 },
            { id: 'q27', title: 'Mandar uma mensagem dizendo que está com saudade', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 30, xp: 10 },
            { id: 'q28', title: 'Relembrar rapidamente como vocês se conheceram', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 15, xp: 15 },
            { id: 'q29', title: 'Escolher uma foto favorita de vocês e enviar', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 20, xp: 20 },
            { id: 'q30', title: 'Fazer um café, chá ou bebida para seu amor', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 10 },
            ...
            { id: 'q38', title: 'Falar uma qualidade que você aprendeu a admirar com o tempo', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 20 },
            { id: 'q39', title: 'Arrumar uma pequena coisa para facilitar o dia do seu amor', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 30, xp: 10 },
            { id: 'q40', title: 'Dizer qual momento recente juntos você mais gostou', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 15, xp: 15 },
            ...
            { id: 'q50', title: 'Ficar 10 minutos sem celular dando atenção total ao seu amor', difficulty: 'easy', difficultyLabel: 'Fácil', reward: 25, xp: 20 },
            ...
            { id: 'q95', title: 'Contar algo vulnerável que você gostaria que seu amor entendesse melhor', difficulty: 'medium', difficultyLabel: 'Média', reward: 35, xp: 50 },
            { id: 'q96', title: 'Montar uma pequena retrospectiva dos melhores momentos do último mês', difficulty: 'medium', difficultyLabel: 'Média', reward: 45, xp: 30 },
            { id: 'q97', title: 'Aprender algo pequeno que seu amor gosta e mostrar o que descobriu', difficulty: 'medium', difficultyLabel: 'Média', reward: 55, xp: 40 },
        ...
        window.signInWithGoogle = async () => {
            ...
            try {
                ...
                // onAuthStateChanged é a única fonte responsável por restaurar/abrir o Elo.
                // Antes o mesmo login fazia duas leituras de perfil e podia iniciar setupSync duas vezes.
...
window.checkInToday = async (buttonEl = null) => {
        ...
        const renderChatOnly = () => {
            ...
            if(existingShell && document.getElementById('chat-input')){
                ...
                if(messagesEl){
                    ...
                    const newlyArrived = chatMessages.filter(m => !chatRenderedMessageIds.has(m.id) && m.senderId !== currentUser.uid).length;
        ...
        window.removeEloFriend = async friendId => {
            ...
            if (!confirm('Remover este Elo da lista de amigos?')) return;

            const myRef = doc(db,'relationships',coupleId);
            const friendRef = doc(db,'relationships',friendId);
            ...
            try {
                await runTransaction(db, async transaction => {
                    ...
                    if (mySnap.exists()) {
                        transaction.update(myRef,{
                            [`social.friends.${friendId}`]:deleteField()
                        });
                    }

                    if (friendSnap.exists()) {
                        transaction.update(friendRef,{
                            [`social.friends.${coupleId}`]:deleteField()
                        });
                    }
                });
                ...
                console.error('Remover amizade:',e);
                showToast('Não foi possível remover a amizade.','error');
            }
        };
        ...
        window.saveRelationshipStartDate = async () => {
            ...
            if(changing && !confirm('Alterar a data do relacionamento recalcula dias juntos, marcos e retrospectivas. Deseja continuar?')) return;
            try{await updateDoc(doc(db,'relationships',coupleId),{relationshipStartDate:value,relationshipStartDateUpdatedAt:Date.now()});closeGenericModal();showToast('Data do relacionamento salva! ❤️','success');}catch(e){console.error(e);showToast('Não foi possível salvar a data.','error');}
        };
        ...
        window.addMoment = async e => {
            ...
            try{
                ...
                if (!coupleData?.achievements?.first_moment) runEloIdle(()=>unlockAchievement('first_moment'));
                    ...
                    <div class="space-y-4 pb-4">
                        ...
                        <section class="elo-home-hero relative overflow-hidden rounded-[2rem] border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950 shadow-2xl">
                            ...
                            <div class="relative z-10 p-5">
                                ...
                                <div class="grid grid-cols-3 gap-2 mt-4">
                                    <div class="elo-home-metric rounded-xl bg-slate-950/60 border border-slate-800 p-3"><p class="text-[8px] uppercase font-black text-slate-500">Sinergia</p><p class="text-lg font-black text-white mt-1">${synergy}</p></div>
                        ...
                        <section class="rounded-[2rem] border border-pink-500/20 bg-gradient-to-br from-pink-500/10 via-slate-900 to-purple-500/10 p-5 shadow-xl">
                            ...
                            <div class="grid grid-cols-2 gap-2 mt-4">
                                ...
                                <button onclick="${myCheckedToday ? "openActivityModal()" : "checkInToday(this)"}" class="elo-action-card rounded-2xl bg-slate-950/70 border border-slate-800 p-3 text-left active:scale-[.98]">
                                    <p class="text-[9px] uppercase font-black text-orange-400">Chama</p>
                                    <p class="font-black text-white text-sm mt-1">${myCheckedToday ? 'Sua parte feita ✓' : 'Fazer agora 🔥'}</p>
                                    <p class="text-[9px] text-slate-500">${streak.current || 0} dias atuais</p>
                                </button>
                            </div>
                        </section>
