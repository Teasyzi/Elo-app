import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
        ...
        const ELO_RELEASE_NOTES = [
            ...
            '🕳️ Galáxia Celestial refinada com buraco negro, cometas lentos e espaguetificação progressiva.'
        ];
        ...
        const ELO_ANDROID_VERSION = isNativeApp ? { versionName:'0.8.9', versionCode:33 } : { versionName:'0.0.0-web', versionCode:0 };
...
window.checkInToday = async (buttonEl = null) => {
        ...
        // ===== PET DO ELO · V36.9.9 · CENTRAL DOS PETS =====
        ...
        const removeFloatingPetBackdrop=()=>document.getElementById('elo-floating-pet-backdrop')?.remove();
